...
const t01 = (arr, val) => arr.filter((el) => el === val).length;
...
const t03 = (arr, val1, val2) => arr.map(el => (el === val1) ? val2 : el);
...
const t04 = (arr, val1) => {
    const index = arr.findIndex((el) => el === val1);
    arr[index] = 0;
    return arr;
};
...
const t05 = (arr, val1) => {
    const index = arr.findLastIndex((el) => el === val1);
    arr[index] = 0;
    return arr;
};
...
const t07 = (arr1) => arr1.find(el => el > 10 && el < 13);
...
const t08 = (arr1) => arr1.toReversed().find(el => el > 10 && el < 13);
...
const t09 = (arr, val) => arr.findIndex((el) => el == val);

document.querySelector('.b-9').addEventListener('click', () => {
    const arr_09 = [1, 12, 3, 4, 4, 5];
    document.querySelector('.out-9').textContent = t09(arr_09, 12);
});
...
const t10 = (arr, val) => arr.findLastIndex((el) => el == val);
...
const t11 = () => {
    res_11 = [];
    arr_11.forEach((el, index) => res_11.push(index));
};
...
const t12 = () => {
    res_12 = [];
    arr_12.forEach((el, index) => {
        if (el % 2 === 0) res_12.push(index);
    });
};
...
const t14 = () => {
    res_14 = [];
    arr_14.forEach((el, index) => {
        if (index % 2 === 0) res_14.push(el);
    });
};
